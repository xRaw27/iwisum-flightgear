...
def train_ppo_continuous_actions(args: Args):
...
def evaluate_ppo_continuous_actions(eval_args: EvalArgs, args: Args):
...
if __name__ == "__main__":
    ...
    if config.mode == "train":
        train_ppo_continuous_actions(config.args)
    elif config.mode == "eval":
        evaluate_ppo_continuous_actions(config.eval_args, config.args)
    else:
